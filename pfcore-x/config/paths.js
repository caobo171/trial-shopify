...
module.exports = {
	...
	// appTsProdConfig: resolveApp('tsconfig.json'),
	 helperFile: resolveApp(`src/${DIR}/helper.ts`),
	// mainStyleFile: resolveApp(`src/${DIR}/pfstyles/index.js`),
	// resetStyleFile: resolveApp(`src/${DIR}/pfstyles/reset.js`),
	// animationStyle: resolveApp(`src/${DIR}/pfstyles/animation.js`),
	// appDir: resolveApp(`src/${DIR}`),
	// appShopify: resolveApp(`src/shopify`),
